...
class User(Base):
    ...
    # lista de permissões separadas por vírgula (ex.: "dashboard,vendas")
    permissions = Column(Text, nullable=True, default="vendas")
...
class Product(Base):
    ...
    # imagem principal do produto (usada também no PDV)
